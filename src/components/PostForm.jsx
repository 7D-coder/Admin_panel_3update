...
function PostForm({initialPost, busy, postBtnTitle, resetAfterSubmit ,onSubmit}) {
    ...
    return (
        ...
        <form onSubmit={handleSubmit} className="p-2 flex">
            ...
            <input onChange = {handleChange} value={tags} name="tags" type="text" className="text-xl outline-none focus:ring-1 rounded p-2 w-full" placeholder="Tag one, tag two" />

            <textarea  id="tags" placeholder="Tags" className="resize-none outline-none focus:ring-1 rounded p-2 w-full font-semibold"></textarea>
            </div>
            
            {/* meta description input */}
            <div>
            <label className="text-gray-500" htmlFor="meta">Meta description {meta?.length} / 150 </label>
            <input onChange={handleChange} name="meta" value={meta}  type="text" className="text-xl outline-none focus:ring-1 rounded p-2 w-full" placeholder="Post Title" />

            <textarea  id="meta" placeholder="Meta description" className="resize-none outline-none focus:ring-1 rounded p-2 w-full h-28"></textarea>
            </div>
            </div>
